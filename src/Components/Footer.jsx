...
const Footer = () => {
  return (
    <footer className="w-full font-sans tracking-wide">
      ...
      {/* ===================== UPCOMING BATCHES ===================== */}
      <div className="bg-[#f5f1ea] py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {[
              { title: "BALI – 200 HOUR TTC", date: "May 10, 2026", seats: "5 Seats Left", img: img1 },
              { title: "RISHIKESH – 200 HOUR TTC", date: "June 02, 2026", seats: "8 Seats Left", img: img2 },
              { title: "MYSORE – 200 HOUR TTC", date: "June 16, 2026", seats: "6 Seats Left", img: img3 },
              { title: "BALI – 300 HOUR TTC", date: "July 05, 2026", seats: "7 Seats Left", img: img4 },
            ].map((item, i) => (
              <div
                key={i}
