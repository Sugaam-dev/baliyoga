export const Bali50HourData = {
  ...
  communitySection: {
    ...
    content: {
      ...
      stats: [
        ...
        { value: "YACEP", label: "Yoga Certification", icon: "award" },
        { value: "Multi", label: "Style Yoga", icon: "globe" },
      ],
      bottomText1:
      ...
      features: [
        {
          ...
          sub: "Registerable foundation certification",
        },
        {
          icon: "bed",
          title: "Comfortable Accommodation",
          sub: "Shared & private room options",
        },
        {
          icon: "utensils",
          title: "Sattvic Meals",
        ...
        },
        {
          ...
          sub: "Hatha, Ashtanga, Pranayama & more",
        },
        {
          icon: "compass",
          title: "Bali Cultural Experience",
          sub: "Temples, nature & spiritual atmosphere",
        },
      ],
      images: {
        main:
  ...
  transformationSection: {
    ...
    content: {
      bgImage:
        "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=1600&q=80",
      quoteStart: "Begin your",
      highlight: "multi style yoga journey",
  ...
  practiceSection: {
    ...
    content: {
      ...
      title: "Foundation of",
      highlight: "Multi Style Yoga & Breath",
      subtitle:
      ...
      specials: [
        {
          ...
          desc: "Suitable for any age group above 18 with no prior experience",
          icon: "heart",
        },
        {
          title: "Multi Style Foundation",
          desc: "Covers Hatha, Ashtanga, Pranayama, Philosophy & Anatomy",
          icon: "shield",
        },
        {
          title: "Pathway to Advanced",
          desc: "Extend seamlessly to 100, 200 or 500-hour TTC",
          icon: "sparkles",
        },
      ],
    },
      ...
      phases: [
        {
          title: "Foundation",
          days: "Days 1–2",
          desc: "Meditation, Pranayama & intro to yoga styles",
          color: "#2E3A87",
        },
        {
          title: "Development",
          days: "Days 3–4",
          desc: "Hatha, Ashtanga, Anatomy & Philosophy",
          color: "#5B4FCF",
        },
        {
          title: "Integration",
          days: "Days 5–6",
          desc: "Alignment, Adjustment & teaching practice",
          color: "#7BAF8A",
        },
      ],

      cta: {
        title: "Become a Confident Multi Style Yoga Practitioner",
        desc:
