      ...
      <div className="mx-auto w-full max-w-7xl px-6 md:px-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6 mt-8">
          {galleryList.map((img, index) => (
            <div
              key={index}
              className="group relative overflow-hidden rounded-[24px] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-500 border border-stone-200/20"
            >
              {/* IMAGE */}
