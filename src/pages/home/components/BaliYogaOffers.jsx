      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {offers.map((offer) => (
            <div
              key={offer.id}
              className="group relative overflow-hidden rounded-[30px] shadow-sm hover:shadow-xl transition-all duration-500 border border-stone-200/40"
            >
              {/* Image Container */}
              <div className="relative aspect-[3/4] w-full overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-6 sm:p-8">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {/* High-visibility colorful gradient discount badge */}
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Highlighted Discount Box with Gray Background/Border and Colorful Text */}
