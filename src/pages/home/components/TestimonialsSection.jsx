      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {visibleTestimonials.map((item, index) => (
            <div
              key={index}
              className="group relative overflow-hidden rounded-[28px] border border-stone-200/40 bg-white p-6 sm:p-7 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-500 flex flex-col justify-between"
            >
              <div>
                {/* Quote / Star Row */}
        ...
        {testimonials.length > visibleTestimonials.length && (
          <div className="mt-12 flex justify-center">
            <button
              ...
              className="inline-flex items-center gap-2 border border-[#c38b5f] text-[#c38b5f] hover:bg-[#c38b5f] hover:text-white px-8 py-3 rounded-full text-xs font-bold uppercase tracking-wider transition-all duration-300 shadow-sm hover:shadow-md cursor-pointer"
            >
