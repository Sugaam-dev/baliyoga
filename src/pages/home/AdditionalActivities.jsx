...
// const AdditionalActivities = () => {
//   return (
//     <div className="min-h-screen bg-gradient-to-b from-[#f5f3ec] via-[#f7f3ee] to-[#efe7dc] py-16 md:py-14 px-4 overflow-hidden">
      
//       {/* HEADER */}
//       <div className="text-center max-w-3xl mx-auto mb-16">
//         {/* <div className="text-[#d97706] text-4xl mb-4 animate-pulse">
//           🪷
//         </div> */}
...
//         <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-[#234b2c] leading-tight">
//           Additional Activities
//         </h2>
...
//         <p className="text-gray-600 text-sm md:text-base leading-7 mt-6 max-w-2xl mx-auto">
...
//           <div
//             key={index}
//             className="group bg-white rounded-[28px] overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 border border-[#e8ddd1]"
//           >
//             {/* IMAGE */}
...
//               {/* ICON BADGE */}
//               <div className="absolute -bottom-7 left-1/2 transform -translate-x-1/2 bg-gradient-to-br from-[#234b2c] to-[#d97706] w-16 h-16 flex items-center justify-center rounded-full shadow-xl border-4 border-white transition-all duration-500 group-hover:scale-110">
...
//             {/* CONTENT */}
//             <div className="pt-12 pb-8 px-7 text-center">
//               <h3 className="text-[#234b2c] font-serif font-semibold text-2xl mb-4 group-hover:text-[#d97706] transition duration-300">
//                 {item.title}
//               </h3>
...
//               {/* BUTTON */}
//               <button className="mt-6 inline-flex items-center gap-2 text-[#234b2c] hover:text-[#d97706] font-semibold text-sm uppercase tracking-wide transition-all duration-300 group-hover:gap-3">
//                 Explore More
