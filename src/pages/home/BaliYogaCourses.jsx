...
//   return (
//     <div className="bg-[#f7f3ee] py-14 md:py-20">
//       {/* COURSES SECTION */}
...
//           <h2 className="text-[#2d2d2d] text-3xl sm:text-4xl md:text-5xl font-serif font-semibold leading-tight">
...
//             <div
//               key={index}
//               className="bg-white rounded-[24px] overflow-hidden border border-[#e8ddd1] shadow-sm hover:shadow-2xl transition-all duration-500 group"
//             >
//               {/* IMAGE */}
...
//               {/* CONTENT */}
//               <div className="p-6">
//                 <h3 className="text-[#2d2d2d] text-[20px] leading-snug font-serif font-semibold min-h-[78px]">
//                   {course.title}
//                 </h3>
...
//                 <button className="flex items-center gap-2 text-[#314120] text-sm font-semibold uppercase tracking-wide hover:gap-3 transition-all duration-300">
//                   View More
//                   <ArrowRight size={16} />
//                 </button>
//               </div>
...
//               className="bg-[#314120] hover:bg-[#253218] text-white px-9 py-3 rounded-full text-sm font-semibold tracking-wide transition-all duration-300 shadow-lg hover:scale-105"
//             >
