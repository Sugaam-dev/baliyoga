  ...
  return (
    <div style={styles.container}>
      ...
      <p style={styles.paragraph}>
        Welcome to OmBreath Yoga. By accessing and using our website,
      ...
      <p style={styles.paragraph}>
        ...
        of OmBreath Yoga and may not be copied, reproduced, or
      ...
      <p style={styles.paragraph}>
        OmBreath Yoga shall not be liable for any injury, loss, damage,
