...
export const courseData = {
  heroSection: {
    colors: {
      ...
      overlay:
        "linear-gradient(180deg, rgba(62,39,35,0.6), rgba(62,39,35,0.96))",
      white: "#ffffff",
    ...
    certificates: [
      { img: "/images/external/general/unsplash_photo-1607004468138-e7e23ea26947.webp", label: "Ayurveda Therapist" },
  ...
  highlightsSection: {
    ...
    colors: {
      ...
      goldLight: "#D35400",
      overlay:
        "linear-gradient(180deg, rgba(93,64,55,0.72), rgba(41,26,24,0.98))",
    ...
    content: {
      ...
      subtitle:
        "Bali Yoga Kendra in Bali delivers pure Ayurvedic treatment disciplines, bringing body, mind, and spirit into total alignment using authentic medicated herbal oils.",
      stats: [
    ...
    colors: {
      ...
      overlay: "linear-gradient(to top, rgba(41,26,24,0.6), transparent)",
    },
    ...
    content: {
      ...
      images: {
        ...
        food:
          "/images/external/general/unsplash_photo-1496042399014-dc73c4f2bde1.webp", // Vegetarian Sattvic Asset URL
        stay:
  ...
  practiceSection: {
    ...
    content: {
      ...
      specials: [
        ...
        {
          title: "Full Practice Material Bundles",
          desc: "All dynamic oils, botanical sheets, study logs, and assessment diaries stand fully supplied upon arrival points.",
          icon: "shield",
        },
        {
          title: "Dual Theoretical-Practical Weight",
          desc: "We anchor structural demonstration requirements alongside rigorous academic breakdowns of the 5 elements theory.",
          icon: "sparkles",
        },
      ],
    },
  ...
  programDetailsSection: {
    ...
    content: {
      ...
      courses: [
        {
          title: "Ayurveda Foundational Philosophy",
          icon: "sparkles",
          items: [
            "Basic ancient conceptual histories",
            "Panch Maha Bhutas (5 elements theory)",
            "Prakriti body type constitutions analysis",
            "Tri-Dosha systemic driving forces mapping",
          ],
        },
        {
          title: "Full Body Abhyanga Track",
          icon: "wind",
          items: [
            "Preparation protocols for medicated fluids",
            "Front body stroke synchronization models",
            "Back body muscle execution patterns",
            "Marma point identification tracking",
          ],
        },
        {
          title: "Liquid Stream Specializations",
          icon: "brainCircuit",
          items: [
            "Shirodhara equipment and fluid pacing rules",
            "Takradhara with medicated butter-milk layers",
            "Pizhichil warm squeeze infusion sets",
            "Calming nervous system interaction pathways",
          ],
        },
        {
          title: "Localized Heat & Purgation",
          icon: "book",
          items: [
            "Podikkizhi herbal powder poultice processing",
            "Pinda Swedana thermal steaming actions",
            "Kati Basti regional spinal heat rings",
            "Nasyam traditional nasal delivery routines",
          ],
        },
        {
          title: "Regional Massage Sub-Sets",
          icon: "heart",
          items: [
            "Shiroabhyanga intense head treatments",
            "Mukha Abhyangam facial strokes logic",
            "Padho Abhyangam technical foot paths",
            "Foot reflexology system mapping tools",
          ],
        },
        {
          title: "Esthetic & Special Therapies",
          icon: "brain",
          items: [
            "Ayurvedic herbal facial preparation labs",
            "Netra Tarpana optical bathing processes",
            "Navara Kizhi grain steaming parameters",
            "Client safety mapping from tissue strain",
          ],
        },
      ],
    ...
    content: {
      ...
      highlight: "Within the Program Blocks",
      subtitle:
      ...
      afternoon: [
        { time: "01:00 PM - 02:00 PM", activity: "Sattvic Lunch Service", icon: "utensils" },
        { time: "02:00 PM - 03:00 PM", activity: "Mandatory Rest and Digestion Rest Block", icon: "book" },
        { time: "03:30 PM - 04:30 PM", activity: "Ayurveda Fundamental Core Theory Lectures", icon: "feather" },
        ...
        { time: "07:30 PM", activity: "Clean Ashram Dinner Service", icon: "utensils" },
      ],

      sections: {
        morningTitle: "Systemic Mobilization and Morning Practical Labs",
        afternoonTitle: "Academic Foundations and Twilight Execution Sheets",
        note:
          "Timetable placements and hourly blocks can be subject to conditional modification based on environmental mountain seasons or weather vectors.",
      },
    },
  },
  },
  ...
  experienceSection: {
    ...
    content: {
      ...
      philosophy: [
        ...
        { icon: "feather", title: "Karma Yoga Service", desc: "Keeping personal spaces highly organized works as an extension of training discipline" },
      ],
    },
  },
    excursion: {
    ...
    content: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Yes! Bali Yoga Kendra is an authorized registration space. Graduating this 12-day therapist track provides you with a formal Yoga Alliance YACEP certificate to verify your expert status globally.",
        },
        {
