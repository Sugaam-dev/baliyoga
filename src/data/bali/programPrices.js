...
export const ROOM_PRICES_BALI = {
  ...
  "kundalini200hr": {
    durationDays: 20,
    rooms: [
      { type: "6 Sharing Room", current: 1299, original: 1699, note: "Females Only", popular: false },
      { type: "4 Sharing Room", current: 1499, original: 1899, note: "Females Only", popular: false },
  ...
  "kundalini300hr": {
    durationDays: 30,
    rooms: [
      { type: "6 Sharing Room", current: 1599, original: 1999, note: "Females Only", popular: false },
      { type: "4 Sharing Room", current: 2199, original: 2799, note: "Females Only", popular: false },
  ...
  "kundalini500hr": {
    durationDays: 50,
    rooms: [
      { type: "6 Sharing Room", current: 2599, original: 3199, note: "Females Only", popular: false },
      { type: "4 Sharing Room", current: 2999, original: 3599, note: "Females Only", popular: false },
  ...
  "yinyoga": {
    durationDays: 6,
    rooms: [
      { type: "Without Food & Stay", current: 499, original: 899, note: "No Food & No Stay", popular: false },
      { type: "2 Sharing Room", current: 650, original: 1050, popular: true },
      { type: "Private Room", current: 750, original: 1150, popular: false }
    ]
  },
  ...
  "aerialyoga": {
    durationDays: 5,
    rooms: [
      { type: "Without Food & Stay", current: 399, original: 799, note: "No Food & Stay", popular: false },
  ...
  "ayurveda5hoursabhyangam": {
    durationDays: 2,
    rooms: [
      { type: "Course Fee", current: 250, original: 500, note: "5 Hr training 1/2days", popular: true }
    ]
  },
  "retreats6days": {
    durationDays: 6,
  ...
  "3daywellness": {
    durationDays: 3,
    rooms: [
      { type: "2 Sharing Room", current: 350, original: 750, popular: true },
      { type: "Private Room", current: 400, original: 850, popular: false }
    ]
  },
  "adventureyoga": {
    durationDays: 7,
